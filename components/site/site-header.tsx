    ...
    <header className="sticky top-0 z-40 w-full border-b border-[var(--border)] bg-[var(--background)]/95 backdrop-blur-md">
                        ...
                        {item.children.map((c) => (
                          <Link
                            ...
                            className={cn(
                              ...
                              pathname === c.href && "bg-[var(--accent-soft)]",
                            )}
                            role="menuitem"
                          >
                            <div
      ...
      {open && (
        <>
          ...
          <button
            type="button"
            className="lg:hidden fixed inset-0 top-16 sm:top-20 bg-black/20 z-30"
            aria-label="Sluit menu"
            onClick={() => setOpen(false)}
          />
          <div
            id="mobile-menu"
            className="lg:hidden fixed inset-x-0 top-16 sm:top-20 bottom-0 z-40 bg-[var(--background)] overflow-y-auto flex flex-col"
          >
            <nav
