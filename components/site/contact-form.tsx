...
const contactSchema = z.object({
    ...
    consent: z.literal(true, {
        message: "U moet toestemming geven voordat het bericht verstuurd kan worden.",
    }),
                ...
                <div className="flex items-start gap-2">
                    ...
                    <div>
                        ...
                        <p className="text-[var(--foreground)] leading-relaxed">
                            Ik verwerk uw gegevens uitsluitend om contact met u op te
                            nemen. Uw bericht wordt per e-mail aan mij verzonden en niet
                            opgeslagen in een database. Gegevens worden bewaard zolang dat
                            voor onze contactlegging nodig is, en daarna verwijderd.{" "}
                            <Link
                ...
                <div className="grid sm:grid-cols-2 gap-5">
                    <div className="space-y-2">
                        ...
                        {errors.name && (
                            <p
                                id="name-error"
                                className="text-sm text-[var(--error-fg)]"
                            >
                                {errors.name.message}
                            </p>
                        )}
                    ...
                    <div className="flex items-start gap-3">
                        <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                                setValue("consent", checked === true ? (true as const) : (false as unknown as true), {
                                    shouldValidate: true,
                                })
                            }
