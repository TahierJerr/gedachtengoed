...
export function physicianSchema(): JsonLd {
  return {
    ...
    memberOf: [
      {
        "@type": "Organization",
        name: "Landelijke Vereniging van Vrijgevestigde Psychologen & Psychotherapeuten (LVVP)",
      },
      { "@type": "Organization", name: "Vereniging voor Schematherapie (VSt)" },
      {
        "@type": "Organization",
        name: "Vereniging voor Gedrags- en Cognitieve Therapieën (VGCT)",
      },
      {
        "@type": "Organization",
        name: "Vereniging Persoonsgerichte experiëntiële Psychotherapie (VPeP)",
      },
    ...
    hasCredential: [
      {
        ...
        credentialCategory: `BIG-registratie psychotherapeut ${siteConfig.business.bigPsychotherapeut}`,
      },
      {
        "@type": "EducationalOccupationalCredential",
        credentialCategory: `BIG-registratie GZ-psycholoog ${siteConfig.business.bigGzPsycholoog}`,
      },
    ],
  };
}
