        ...
        <Container style={containerStyle}>
          ...
          <Section style={cardStyle}>
            ...
            <Text style={paragraphStyle}>
              Bedankt voor uw bericht. Ik heb uw aanvraag in goede orde
              ontvangen en neem zo spoedig mogelijk contact met u op, meestal
              binnen enkele werkdagen.
            </Text>

            <Text style={paragraphStyle}>
              In dat eerste contact bespreken we kort uw vraag en kunnen we
              samen nagaan of een intakegesprek bij mij zinvol is.
            </Text>

            {/* Recap of their message */}
            <Section style={recapBoxStyle}>
              <Text style={recapLabelStyle}>Uw bericht</Text>
              <Text style={recapSubjectStyle}>Onderwerp: {subject}</Text>
            ...
            <Text style={paragraphStyle}>
              ...
              <br />
              De wachttijd voor nieuwe aanmeldingen is op dit moment circa 12
              weken. Actuele informatie vindt u altijd op{" "}
              <Link
            ...
            <Text style={paragraphStyle}>
              ...
              <br />
              Voor vergoeding via de zorgverzekering heeft u een verwijsbrief
              van uw huisarts nodig. U mag deze later aan mij doorsturen, die
              kan ook na het eerste telefonisch contact.
            </Text>

            {/* Crisis notice */}
            <Section style={crisisBoxStyle}>
              <Text style={crisisLabelStyle}>In geval van crisis</Text>
              <Text style={crisisTextStyle}>
                Bevindt u zich in een acute crisis? Neem dan contact op met uw
                huisarts of de huisartsenpost. Voor 24/7 ondersteuning kunt u
                terecht bij{" "}
            ...
            <Text style={signatureStyle}>Met vriendelijke groet,</Text>
