...
export function PracticeNotificationEmail({
    ...
    return (
        <Html lang="nl">
            <Head />
            <Preview>
                Nieuw bericht via het contactformulier van {name}
            </Preview>
                ...
                <Container style={containerStyle}>
                    ...
                    <Section style={cardStyle}>
                        ...
                        <Text style={paragraphStyle}>
                            Er is een nieuw bericht binnengekomen via het
                        ...
                        <Text style={actionHintStyle}>
                            U kunt direct antwoorden op deze e-mail — uw reactie
                            gaat naar het opgegeven adres van de verzender.
                        </Text>
                    </Section>
                    ...
                    <Section style={footerStyle}>
                        <Text style={footerTextStyle}>
                            Dit bericht is automatisch verstuurd vanaf het
