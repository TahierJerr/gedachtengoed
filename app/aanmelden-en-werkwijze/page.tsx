  ...
  return (
    <>
      ...
      <article className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-16 prose-content">
        <h2>Aanmelden</h2>
        <p>
          U kunt zich via het <Link href="/contact">contactformulier</Link>{" "}
          aanmelden. Ik zal dan vrijblijvend telefonisch contact met u opnemen.
          In dat gesprek zullen we kort stil staan bij uw klachten en hulpvraag.
          We kunnen dan nagaan of verdere (intake)gesprekken bij mij zinvol
          zijn. Als dat zo is, plannen we een afspraak in voor een eerste
          intakegesprek.
        </p>
        <p>
          U heeft dan een verwijsbrief nodig van uw huisarts. Als u in
          aanmerking wilt komen voor vergoeding van de behandeling vanuit de
          zorgverzekeraar moet in de verwijsbrief in ieder geval het volgende
          staan:
        </p>
        <ul>
        ...
        <p>
          ...
          met uw zorgverzekeraar en vragen om wachtlijstbemiddeling. Uw
        ...
        <h3>Intake</h3>
        <p>
          De intakefase bestaat uit 2 tot 3 gesprekken. We brengen in kaart
          welke klachten er spelen, wat uw verwachtingen en hulpvraag zijn, wat
          uw verhaal en levensgeschiedenis is waarbinnen deze klachten zijn
          ontstaan en welke hulp nodig is. Ook kunnen vragenlijsten worden
          afgenomen om een beter beeld te krijgen van de problematiek en de
          ernst ervan. Daarna volgt een adviesgesprek waarin kan worden besloten
          tot psychotherapie of tot doorverwijzing. Als ik denk dat u elders
          beter geholpen kunt worden, zal ik dat met u bespreken en mij inzetten
          om u zo goed mogelijk door te verwijzen.
        </p>
        ...
        <p>
          ...
          Tevens wordt de frequentie en, als mogelijk, de verwachte duur van de
          behandeling vastgesteld. De behandelovereenkomst wordt door ons beide
          ondertekend. Als u hiervoor toestemming geeft, wordt uw verwijzer
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="!text-[var(--error-fg)]">
                De praktijk heeft geen faciliteiten voor opvang bij crisis. Voor
                cliënten die bij mij in zorg zijn ben ik op mijn werkdagen het
                eerste aanspreekpunt. Buiten kantoortijden of bij afwezigheid
                kunt u terecht bij uw huisarts of de dienstdoende
                huisartsenpost.
              </p>
