    ...
    <>
      ...
      <article className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-16 prose-content">
        ...
        <p>
          ...
          psychische klachten en stoornissen. Het helpt zicht te krijgen op
          uzelf en/of op uw problemen. Psychotherapie kan u handvatten bieden om
          anders met uw problemen om te gaan, pijnlijke gevoelens te verwerken
          en meer in contact te komen met uzelf. De problemen waarvoor mensen in
          psychotherapie gaan zijn heel verschillend. Het doel is uw psychische
          klachten op te heffen, of zoveel te verminderen dat u er minder last
          van heeft.
        </p>
        ...
        <p>
          ...
          . Dat wil zeggen dat de therapie op u, uw hulpvraag en het
          klachtenbeeld wordt afgestemd. Hierbij wordt gebruik gemaakt van een
          combinatie van verschillende interventies en methoden uit
          verschillende therapiestromingen die aansluiten bij uw klachten en
          hulpvraag.
        </p>
