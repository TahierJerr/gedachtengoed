    ...
    return (
        <>
            ...
            <article className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-16 prose-content">
                ...
                <ul>
                    <li>Angstklachten, onzekerheid, paniek, sociale angst en overmatig piekeren</li>
                    <li>Stemmingsklachten, somberheid, depressiviteit, gevoelens van schuld en schaamte</li>
                ...
                <div className="mt-12 p-6 bg-[var(--warning-bg)] border border-[var(--warning-border)] rounded-lg">
                    <h2 className="!mt-0 text-2xl !text-[var(--warning-fg)]">Wanneer niet?</h2>
                    ...
                    <p className="!text-[var(--warning-fg)]">
                        Als <strong>psychose(s), crisis, acute suïcidaliteit,
                        zelfverwonding, ernstige verslavingsproblematiek, een ernstige
                        eetstoornis of agressie-problematiek</strong> op de voorgrond staan
                        is een gespecialiseerd aanbod en een multidisciplinaire behandeling
                        elders meer geïndiceerd.
                    </p>
