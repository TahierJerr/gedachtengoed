                    ...
                    <aside className="space-y-6">
                        ...
                        <div className="bg-white border border-[var(--border)] rounded-lg p-6">
                            ...
                            <p className="text-sm text-[var(--muted)] leading-relaxed mb-3">
                                De spreekkamer bevindt zich in het souterrain en is
                                bereikbaar via een trap. Er is voldoende gelegenheid tot
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-[var(--error-fg)] leading-relaxed">
                                        ...
                                        ondersteuning: <strong>113.nl</strong> — bereikbaar
                                        24/7 via <strong>0800-0113</strong>.
                                    </p>
                                </div>
                            </div>
                        </div>
