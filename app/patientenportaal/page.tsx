    ...
    return (
        <>
                    ...
                    <div className="p-4 bg-[var(--warning-bg)] border border-[var(--warning-border)] rounded-lg flex items-start gap-3">
                        ...
                        <div className="text-sm text-[var(--warning-fg)]">
                            ...
                            <p>
                                ...
                                in de environment variables. Deze waardes vindt u in
            ...
            <article className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 pb-16 prose-content">
                ...
                <ul>
                    <li>
                        <strong>Inschrijven</strong> als nieuwe cliënt — uw gegevens
                        komen direct beveiligd in mijn administratie
                    </li>
                    <li>
                        <strong>Vragenlijsten invullen</strong> die u per e-mail
                        toegestuurd krijgt vanuit de praktijk
                    </li>
                    <li>
                ...
                <h2>Vragenlijsten</h2>
                <p>
                    Wanneer ik een vragenlijst voor u klaarzet, ontvangt u een e-mail
                    met een directe link. U hoeft dan niet eerst in te loggen — de
                    link in de e-mail brengt u rechtstreeks naar de juiste vragenlijst.
                </p>

                <h2>Beveiliging en privacy</h2>
                <p>
                    Het patiëntenportaal wordt geleverd door <strong>Intramed</strong>,
                    een gespecialiseerde leverancier voor de Nederlandse zorg. Het
                    portaal voldoet aan de beveiligingseisen voor gezondheidsgegevens
                    (NEN 7510) en de Algemene Verordening Gegevensbescherming (AVG).
                    Alle gegevens worden versleuteld verstuurd en opgeslagen in
                    Nederland.
                </p>
                <p>
                    U verlaat deze website wanneer u op een van de knoppen klikt — u
                ...
                <h2>Hulp nodig?</h2>
                <p>
                    Komt u er niet uit met inloggen of inschrijven? Of heeft u geen
                    e-mail met de link voor uw vragenlijst ontvangen? Neem dan{" "}
                ...
                <div className="mt-8 p-5 bg-[var(--muted-background)] border border-[var(--border)] rounded-lg">
                    ...
                    <p className="!mb-0 text-sm text-[var(--muted)]">
                        Inhoudelijke en gezondheidsgerelateerde gegevens horen
                        uitsluitend in het beveiligde portaal of tijdens een afspraak
                        — niet in een gewone e-mail.
                    </p>
                </div>
            </article>
        </>
